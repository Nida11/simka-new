...
function InitMessageBody() {
    ...
    if (MessageBody) {
        var ObjString = "<div><p>Platform & Browser Support: </p>Internet Explorer 6 or above (32 bit/64 bit), any version of Chrome (32 bit/64 bit), any version of Firefox on Windows; Safari, Chrome and Firefox on Mac OS X 10.6 or later; Chrome and Firefox v27 or above (64 bit) on Ubuntu 10-18, Debian 8-9, or Fedora 19+";
        ObjString += ".</div>";
...
function InitBtnGroupBtm(bNeebBack) {
    ...
    if (btnGroupBtm) {
        ...
        objString += "<a class='btn btn-primary btn-xs' onclick='btnFirstImage_onclick()'><span class='glyphicon glyphicon-fast-backward'></span></a>&nbsp;"
        objString += "<a class='btn btn-primary btn-xs' onclick='btnPreImage_onclick()'><span class='glyphicon glyphicon-backward'></span></a> &nbsp;&nbsp;&nbsp;"
        // objString += "<input id='DW_btnFirstImage' onclick='btnFirstImage_onclick()' type='button' value='Last'/>&nbsp;";
        // objString += "<input id='DW_btnPreImage' onclick='btnPreImage_onclick()' type='button' value='Next'/>&nbsp;&nbsp;";
        ...
        objString += "<a class='btn btn-primary btn-xs' onclick='btnNextImage_onclick()'><span class='glyphicon glyphicon-forward'></span></a> &nbsp;"
        objString += "<a class='btn btn-primary btn-xs' onclick='btnLastImage_onclick()'><span class='glyphicon glyphicon-fast-forward'></span></a> &nbsp;&nbsp;&nbsp;"
        //objString += "<input class='btn btn-primary btn-xs' id='DW_btnNextImage' onclick='btnNextImage_onclick()' type='button' value='Previous'/>&nbsp;";
        //objString += "<input class='btn btn-primary btn-xs' id='DW_btnLastImage' onclick='btnLastImage_onclick()' type='button' value='Prev'/></div>";
        objString += "<div class='ct-rt'>View: ";
        objString += "<select size='1' id='DW_PreviewMode' onchange ='setlPreviewMode();'>";
        objString += "    <option value='0'>1X1</option>";
        objString += "</select> &nbsp;&nbsp;";
        objString += "<a class='btn btn-danger btn-xs' onclick='DW_btnRemoveCurrentImage()'><span class='glyphicon glyphicon-remove'></span> Selected</a> &nbsp;&nbsp;"
        objString += "<a class='btn btn-danger btn-xs' onclick='btnRemoveAllImages_onclick()'><span class='glyphicon glyphicon-remove'></span> All</a>"
        objString += "</div>";

        if (bNeebBack) {
              // objString += '<br>';
              // objString += "<div class='removeImage'>";
              //objString += "<div class='ct-rt'>";
              //objString += '<br>';
