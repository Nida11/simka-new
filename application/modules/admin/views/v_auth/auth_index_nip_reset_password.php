  ...
  <div class="auth panel_container" ng-app="simka_bapenda">
    <div class="panel panel-primary shdw5-black">
      ...
      <div class="panel-body">
        ...
        <form class='form_natural normal_form' name='form' action='<?php echo base_url(); ?>auth/reset_password_password' method='POST'>
          ...
          <div class="input-group">
            <span class="input-group-addon" id="auth_username"><span class='glyphicon glyphicon-certificate'></span></span>
            <input type="password" name='c_p' class="form-control" placeholder="Konfirmasi Ulang Password" aria-describedby="auth_password" autofocus>
          </div>
          <br>
          <input class='btn form-control btn-xs btn-danger pull-right' type='submit' name='submit' value='RESET PASSWORD'/>
        </form>
      </div>
    </div>
  </div>
