			    ...
			    <div class="col-lg-8 mrgbt10 mrgrg100">
                    <div class="input-group">
                        ...
                        <select class="form-control select2" name="kd_plat" data-ng-model="kd_plat">
                            <option value="" selected="selected">Hitam / Putih</option>
                    ...
                    <div id="divUpload" class="divinput mt30" style="position:relative">
                        <ul>
                            ...
                            <li>
                                ...
                                <label style='width: 60px'>Kd.Mohon</label>
                                ...
                                <label style='width: 60px'>Lokasi</label> 
                                <input id='url_local_path' type="text" size="20" data-ng-model='sync_url_local_path' name="sync_url_local_path" disabled/>
                            </li>
